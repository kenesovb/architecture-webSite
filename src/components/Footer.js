    ...
    <div className="footer-container">
      ...
      <div className="footer-column1">
        <div className="column1">
          ...
          <p> г. Нур-Султан, ул. Иманбаева 8/2, 7 этаж, офис №7."БЦ " Inteh plus" </p>
          <p> г. Алматы, ул. Егизбаева 7В, офис №607. БЦ "Жел Таун" </p>
          <p> © 2016 - 2022 ТОО "ПРОЕКТ ИНТЕХ плюс" </p>
        </div>
        <div className="column2">
          ...
          <p>
            «Copyright © 2017 - 2018 by ТОО "Проект Интех плюс".
